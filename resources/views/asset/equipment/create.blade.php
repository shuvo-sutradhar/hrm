        ...
        <main id="main-container">
            ...
            <div class="content d-flex justify-content-center">
                <div class="col-md-6">
                    ...
                    {!! Form::open(['method'=>'POST','action'=>'EquipmentController@store', 'class'=>'form-horizontal form-validation']) !!}
                    @csrf
                                ...
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    <div class="col-sm-10 col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('asset_type_id',[''=>'Choose Asset Type'] + $assetType,null,['class' => 'form-control']) !!}
