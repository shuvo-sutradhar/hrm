            ...
            <div class="bg-body-light">
                <div class="content content-full">
                    <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Add Permission</h1>
                    </div>
                </div>
            </div>
            <!-- END Hero -->
                ...
                <div class="col-md-6">
                 ...
                 @if(Session::has('permission-add'))
                    <div class="alert alert-success" style="margin-bottom: 30px">
                      <strong>{{Session('permission-add')}}</strong>
                    </div>
                  @endif

                    {!! Form::open(['method'=>'POST','action'=>'PermissionController@store', 'class'=>'form-horizontal form-validation']) !!}
                    @csrf
