        ...
        <main id="main-container">
            ...
            <div class="content d-flex justify-content-center">
                <div class="col-md-6">
                    ...
                    {!! Form::model($award, ['method'=>'PUT','action'=>['AwardController@update',$award->id], 'class'=>'form-horizontal form-validation','files'=>true]) !!}
                    @csrf
                                ...
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    <div class="col-sm-10 col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::selectMonth('month',$award->month,['class'=>'form-control']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            {!! Form::selectRange('year', $today->year, 2010, $award->year,['class'=>'form-control']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image">
                                                ...
                                                <img width="300" style="border: 2px solid #999;" src="{{$award->award_img ? asset('admin-assets/media/award/'.$award->award_img) : 'http://placehold.it/100x100'}}">
