        ...
        <main id="main-container">
            ...
            <div class="content d-flex justify-content-center">
                <div class="col-md-6">
                    ...
                    {!! Form::model($leaveRequest, ['method'=>'PATCH','action'=>['LeaveRequestController@update',$leaveRequest->id], 'class'=>'form-horizontal form-validation','files'=>true]) !!}
                                    ...
                                    <div class="col-sm-10 col-md-10">
                                        <div class="form-group">
                                            ...
                                            <div class='input-group date' id='datetimepicker1'>
                                                {!! Form::text('apply_date',$leaveRequest->apply_date,['class' => 'form-control','id'=>'apply_date','placeholder'=>'Select Date & Time']) !!}
                                        ...
                                        <div class="form-row ">
                                            ...
                                            <div class="form-group single-day">
                                                ...
                                                <div class='input-group date' id='datetimepicker2'>
                                                    {!! Form::text('start_date', $leaveRequest->duration != 2 ? \Carbon\Carbon::parse($leaveRequest->start_date)->format('d M Y') : null ,['class' => 'form-control','id'=>'datetimepicker2','data-date-format'=>'DD MMMM YYYY']) !!}
                                        ...
                                        <div class="form-group multiple-days">
                                            ...
                                            <div class="input-daterange input-group js-datepicker-enabled">
                                                ...
                                                {!! Form::text('from', $leaveRequest->duration == 2 ? \Carbon\Carbon::parse($leaveRequest->start_date)->format('d M Y') : null,['class' => 'form-control','id'=>'startDate','placeholder'=>'From','data-date-format'=>'DD MMMM YYYY']) !!}
                                                ...
                                                {!! Form::text('to', $leaveRequest->duration == 2 ? \Carbon\Carbon::parse($leaveRequest->end_date)->format('d M Y') : null,['class' => 'form-control','id'=>'endDate','placeholder'=>'To','data-date-format'=>'DD MMMM YYYY']) !!}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image">
                                                ...
                                                <img width="300" style="border: 2px solid #999;" src="{{asset('admin-assets/media/leave/'.$leaveRequest->attachment) }}">
                                                @endif
