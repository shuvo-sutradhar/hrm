            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="bg-header-dark">
                    <div class="content-header bg-white-10">
                        ...
                        <a class="link-fx font-w600 font-size-lg text-white" href="index.html">
                            <span class="text-white-75">SAS-</span><span class="text-white">HRM</span>
                        </a>
                        <!-- END Logo -->
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item {{ request()->is('employee*') ? 'open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="{{ route('employee.create') }}">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link {{ request()->is('employee') ? 'active' : '' }}" href="{{ route('employee.index') }}">
                                        <span class="nav-main-link-name">All Employee</span>
                                        <span class="nav-main-link-badge badge badge-pill badge-primary">{{ count(App\User::all()) }}</span>
                                    </a>
                                </li>

                                <li class="nav-main-item">
                                    <a class="nav-main-link" href="be_blocks_options.html">
                                        <span class="{{ route('employee.trash') }}">Trash</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
