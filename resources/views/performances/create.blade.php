        ...
        <main id="main-container">
            ...
            <div class="content d-flex justify-content-center">
                <div class="col-md-6">
                    ...
                    {!! Form::open(['method'=>'POST','action'=>'PerformanceController@store', 'class'=>'form-horizontal form-validation']) !!}
                    @csrf
                                ...
                                <div class="row justify-content-center py-sm-3 py-md-5">
                                    <div class="col-sm-10 col-md-10">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('employeeID',[''=>'']+$users,null,['class' => 'js-select2 form-control','id'=>'xample-select2','data-placeholder'=>'Choose one..']) !!}
