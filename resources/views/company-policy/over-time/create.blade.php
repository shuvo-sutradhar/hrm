        ...
        <main id="main-container">
            ...
            <div class="content">
                ...
                <div class="content d-flex justify-content-center">
                  <div class="col-md-6">
                      {!! Form::open(['method'=>'POST','action'=>'OverTimePolicyController@store', 'class'=>'form-horizontal form-validation']) !!}
                      @csrf
                                      ...
                                      <div class="col-sm-10 col-md-10 overtimeForm">
                                          ...
                                          <div class="form-group custome-input-border">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    {!! Form::checkbox('isDay',null, false,['id'=>'example-checkbox-custom1','class'=>'custom-control-input']) !!}

                                                    <label class="custom-control-label" for="example-checkbox-custom1">After</label>


                                                    {!! Form::number('dayHours','08.00',['id'=>'block-form-permission7','placeholder'=>'08.00', 'disabled'=>'true','placeholder'=>'08.00']) !!} Hours in a day
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    {!! Form::checkbox('isWeek',null, false,['id'=>'example-checkbox-custom2','class'=>'custom-control-input']) !!}

                                                    <label class="custom-control-label" for="example-checkbox-custom2">After</label>

                                                    {!! Form::number('weekHours','40.00',['id'=>'block-form-permission8','disabled'=>'true','placeholder'=>'40.00']) !!} Hours in a week
